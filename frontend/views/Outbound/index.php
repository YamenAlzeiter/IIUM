					...
					<div class = "row">
						<div class = "col-md-6">
							...
							<p class = "mb-2 fw-light mb-1">
								<strong>Citizenship: </strong> <?= $model->Citizenship ?></p>
							<p class = "mb-2 fw-light mb-1">
					...
					<div class = "card shadow-none border bg-light-pink">
						<div class = "card-body">
							...
							<div class = "d-flex gap-3 ">
								...
								<p class = "mb-2 fw-light mb-1">
									<strong>Until: </strong> <?= $model->Mobility_until ?></p>
							</div>
							<p class = "mb-2 fw-light mb-1"><strong>Host University
						...
						<div class = "card-body">
							<div class = "row">
								...
								<div class = "col-lg-6">
									...
									<p class = "mb-2 fw-light mb-1">
										<strong>Country:</strong> <?= $model->Connect_host_country ?></p>
									<p class = "mb-2 fw-light mb-1">
				...
				<div class = "card-body">
                    ...
                    <?php if ($model->Status >= 41): ?>
						<p class = "fw-semibold"><?= ($model->Proof_of_sponsorship) ? Html::a('>Proof of sponsorship', [
                                    'download', 'id' => $model->ID, 'file' => $fileName.'_ProofOfSponsorship'.'.pdf'
                                ]) : ''; ?></p>
						<p class = "fw-semibold"><?= ($model->Other_latest_pay_slip) ? Html::a('>Other Latest Pay Slip',
                                [
                                    'download', 'id' => $model->ID, 'file' => $fileName.'_OtherLatestPaySlip'.'.pdf'
						...
						<p class = "fw-semibold"><?= ($model->Letter_of_indemnity) ? Html::a('>Letter of Indemnity', [
                                    'download', 'id' => $model->ID, 'file' => $fileName.'_LetterOfIndemnity'.'.pdf'
                                ]) : ''; ?></p>
								    ...
								    <div class = "col-md-6">
									    <div class = "mb-3">
                                            <?= $form->field($model, 'Proof_of_sponsorship')->fileInput([
                                                'class' => 'form-control', 'id' => 'Proof_of_sponsorship' , 'required' => true,
                                            ])->label(false) ?>
									    </div>
								    </div>
							    </div>
								    ...
								    <div class = "col-md-6">
									    <div class = "mb-3">
                                            <?= $form->field($model, 'Proof_insurance_cover')->fileInput([
                                                'class' => 'form-control', 'id' => 'Proof_insurance_cover' , 'required' => true,
                                            ])->label(false) ?>
									    </div>
								    </div>
							    </div>
								    ...
								    <div class = "col-md-6">
									    <div class = "mb-3">
                                            <?= $form->field($model, 'Letter_of_indemnity')->fileInput([
                                                'class' => 'form-control', 'id' => 'Letter_of_indemnity' , 'required' => true,
                                            ])->label(false) ?>
									    </div>
								    </div>
							    </div>
								    ...
								    <div class = "col-md-6">
									    <div class = "mb-3">
                                            <?= $form->field($model, 'Flight_ticket')->fileInput([
                                                'class' => 'form-control', 'id' => 'Flight_ticket', 'required' => true,
                                            ])->label(false) ?>
									    </div>
								    </div>
							    </div>
