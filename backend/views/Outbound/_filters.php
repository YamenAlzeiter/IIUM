...
<?php $form = ActiveForm::begin([  'action' => ['index', 'year' => $year], 'method' => 'get']); ?>
<div class = "d-flex flex-row gap-3 align-items-center">
    ...
    <?= $form->field($searchModel, 'Status')->dropDownList(ArrayHelper::map($statusModel, 'ID', 'status'),
        ['prompt' => 'All', 'class' => 'form-select']) ?>

    <?= Html::submitButton('Search',
        ['class' => 'collapsed fs-3 fw-semibold shadow-none btn btn-dark align-self-end']) ?>
