			...
			<div class = "row">
				...
				<div class = "col-md-6">
					...
					<p class = "mb-2 fw-light mb-1"><strong>Passport
					                                        Expiration:</strong> <?= $model->Passport_Expiration ?></p>
...
<?php if ($model->Status === 10 || $model->Status === 35 || $model->Status === 55 || $model->Status === 15): ?>
	<div class = "mt-4 mb-4" id = "radio-buttons">
		...
		<form action = "" class = "d-flex mb-3">
            <?php if ($model->Status === 10 || $model->Status === 35 || $model->Status === 55 || $model->Status === 15): ?>
				<div>
					<input type = "radio" class = "btn-check" name = "inlineRadioOptions" id = "inlineRadio1"
            ...
            <?php if ($model->Status === 10) : ?>
				<div>
					<input type = "radio" class = "btn-check" name = "inlineRadioOptions" id = "inlineRadio2"
					       autocomplete = "off" value = "2">
					<label class = "btn btn-outline-danger rounded-pill font-medium me-2 mb-2" for = "inlineRadio2">Reject</label>
				</div>
            <?php endif; ?>

            <?php if ($model->Status === 10 || $model->Status === 55) : ?>

				<div>
					<input type = "radio" class = "btn-check" name = "inlineRadioOptions" id = "inlineRadio3"
					       autocomplete = "off" value = "3">
					<label class = "btn btn-outline-warning rounded-pill font-medium me-2 mb-2" for = "inlineRadio3">Application
					                                                                                                 Not
					                                                                                                 Complete</label>
				</div>
            <?php endif; ?>
...
<?php endif; ?>
<?php if ($model->Status === 16 || $model->Status === 36): ?>
