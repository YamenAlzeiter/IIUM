...
<?= GridView::widget([
    'dataProvider' => $dataProvider, 'tableOptions' => ['class' => 'table text-nowrap mb-0 align-middle table-hover'],
    ...
    'columns' => [
        'ID', 'status', 'description', [
            ...
            'headerOptions' => ['class' => 'text-dark'], 'format' => 'raw', 'value' => function ($model) {
                $updateButton = Html::a('<i class="ti ti-pencil-minus fs-7"></i>', 'javascript:void(0)', [
                    'class' => 'text-info edit updateStatus-button', 'data-id' => $model->ID, 'data-toggle' => 'modal',
                    'data-target' => '#formpoc', 'title' => 'View and Update', // Tooltip for the 'View' action
                ]);
        ...
        'class' => LinkPager::class, 'options' => ['class' => 'pagination mt-3 justify-content-right pagination-lg'],
    ],
]); ?>
