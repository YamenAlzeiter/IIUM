		...
		<div class = "card-body">
			...
			<div class = "row">
				...
				<div class = "col-md-6">
					...
					<p class = "mb-2 fw-light mb-1"><strong>Passport Number: </strong> <?= $model->Passport_Number ?>
					</p>
					...
					<div class = "form-box">
						<div class = "form-content">
							...
							<div class = "d-flex flex-row align-items-center gap-3">
								<p class = "text-start fs-4 mb-3 fw-semibold">I hereby confirm that this student has
								                                              gone through the rightful university
								                                              selection procedures and recommend that
								                                              the student is qualified to participate in
								                                              the student exchange program stated in the
								                                              application.</p>
