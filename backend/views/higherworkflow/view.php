            ...
            <div class = "card shadow-none border bg-light-subtle flex-fill">
                <div class = "card-body">
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-lg-6">
                            <p class = "mb-2"><strong>Country of
                                                      Origin:</strong> <?= getCountry($model->Country_of_origin) ?></p>
                    ...
                    <div class = "row">
                        <div class = "col">
                            <div>
                                ...
                                <p class = "mb-2"><strong>Programme:</strong> <?= $model->Propose_type_of_programme ?>
                                </p>
                                <p class = "mb-2"><strong>Kulliyyah:</strong> <?= $model->Propose_kulliyyah_applied ?>
                                </p>
                            </div>
                        </div>
                    </div>
