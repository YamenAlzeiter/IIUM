...
class Inbound extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['English_certificate', 'Recommendation_letter', 'Passport', 'Latest_passport_photo', 'Latest_certified_academic_transcript', 'Confirmation_letter', 'Sponsorship_letter', 'offer_letter'], 'file', 'extensions' => 'pdf, doc, docx'],
